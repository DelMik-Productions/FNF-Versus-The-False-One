...
typedef MusicGroup = MusicTypedGroup<MusicObject>;

class AnyMusicGroup extends FlxBasic implements IPlayable
{
	...
	public var members:Array<IPlayable> = [];

	public function add(o:IPlayable):Int
	{
		return members.push(o);
	}

	public function remove(o:IPlayable):Bool
	{
	...
	{
		forEach(o -> o.onResume());
	}

	public function onPrefsChanged():Void
	{
		forEach(o -> o.onPrefsChanged());
	}

	public function onKeyDown(i:Int):Void
	{
		forEach(o -> o.onKeyDown(i));
	}

	public function onKeyUp(i:Int):Void
	{
		forEach(o -> o.onKeyUp(i));
	}

	public function forEach(func:IPlayable->Void):Void
	{
		for (o in members)
		{
			func(o);
...
@:access(flixel.group)
class MusicTypedGroup<T:MusicObject> extends MusicObject
{
	/**
	...
	private function onMemberAdded(basic:T):Void
	{
		basic.playState = playState;
	}
	...
	function get_memberAdded():FlxTypedSignal<T->Void>
	{
		if (_memberAdded == null)
		{
			...
			_memberAdded.add(onMemberAdded);
		}
